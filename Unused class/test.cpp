...
int main() {
    ...
    // 1st method
    testVector.push_back(&test1);  // vector of pointers store the address of
                                   // the data with no additional pointer

    // 2nd method
    testVector.push_back(ptest2);  // vector of pointers store the pointer that
                                   // stores the address of data
    ...
    cout << *(*(testVector.begin() + 1))
         << endl;  // the first * indicate the position of the pointer in the
                   // vector,
