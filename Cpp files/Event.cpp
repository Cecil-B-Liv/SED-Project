...
{
    string input;
    cout << "Welcome, you are browing as guest, check out the following options: " << endl;
    ...
    while (true)
    {
        cout << COLOR_GREEN << "If you want to book one of our supporter, consider joining us here: \n Please select an option: " << COLOR_RESET << endl << endl;
        cout << COLOR_BLUE << "0. Show available supporter in the system." << COLOR_RESET << endl;
        ...
        cout << endl;
        cout << COLOR_RED << "e. Exit - Close the application" << COLOR_RESET << endl;
        cout << COLOR_YELLOW << "h. Return to start screen" << COLOR_RESET << endl;
        cout << endl;
        cout << ">>> ";
...
void Event::adminScreen(){
    ...
    cout << "You are viewing as administrator." << endl;
    elementDivider;
    ...
    while (true)
    {
        cout << COLOR_GREEN << "Please select an option" << COLOR_RESET << endl;
        cout << endl;
        cout << COLOR_BLUE << "1. Reset a member password." << COLOR_RESET << endl;
        cout << endl;
        cout << COLOR_RED << "e. Exit - Close the application" << COLOR_RESET << endl;
        cout << COLOR_YELLOW << "h. Return to start screen" << COLOR_RESET << endl;
        cout << endl;
...
void Event::registerScreen()
{
    ...
    cout << "Succesfully register your account, choose these"
}
